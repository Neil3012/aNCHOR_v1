    ...
    public class ResolveMenuManager : MonoBehaviour
    {
        ...
        public void OnreSolved()
        {
            ...
            switch (dropdown.value)
            {
                ...
                case 1:
                    Controller.ResolvingSet.Add(GetCloudAnchorIdByName("CloudAnchor0"));
                    Controller.ResolvingSet.Add(GetCloudAnchorIdByName("CloudAnchor2"));
                    break;
                case 2:
                    Controller.ResolvingSet.Add(GetCloudAnchorIdByName("CloudAnchor1"));
                    break;
                case 3:
                    Controller.ResolvingSet.Add(GetCloudAnchorIdByName("CloudAnchor0"));
                    Controller.ResolvingSet.Add(GetCloudAnchorIdByName("CloudAnchor1"));
        ...
        private string GetCloudAnchorIdByName(string name)
        {
            for (int i = 0; i < _history.Collection.Count; i++)
            {
                if (_history.Collection[i].Name == name)
                {
                    return _history.Collection[i].Id;
                }
            }
            return null;
        }
